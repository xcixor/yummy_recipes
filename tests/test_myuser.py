...
from myapp.inheritance import Category, User
...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        """
        creates a user object and three categories and adds category_one to the user's collection
        """
    ...
    def test_add_category(self):
        ...
        self.assertEqual(result, [{'name': 'Soups', 'description': 'Goes with other foods', 'owner': 'ptah'},\
    ...
    def test_delete_category(self):
        ...
        result = self.user.delete_item('Main dishes')
        self.assertEqual(result, [{'name': 'Soups', 'description': 'Goes with other foods', 'owner': 'ptah'}])
    ...
    def test_edit_category(self):
        ...
        self.assertEqual(result, [{'name': 'Soups and extra', 'description': 'Goes with other foods', 'owner': 'ptah'}])  
